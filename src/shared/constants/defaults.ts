...
const DEFAULT_TILE_ROWS: Array<{
  ...
  { emoji: "🙏", labelCs: "Prosím", category: "needs" },
  { emoji: "🛏️", labelCs: "Postel", category: "needs" },
  { emoji: "🧥", labelCs: "Bunda", category: "needs" },
  { emoji: "🪥", labelCs: "Zuby", category: "needs" },
  { emoji: "🚪", labelCs: "Ven", category: "needs" },
  { emoji: "🌡️", labelCs: "Teplo", category: "needs" },
  { emoji: "🥶", labelCs: "Zima", category: "needs" },
  { emoji: "💊", labelCs: "Lék", category: "needs" },
  ...
  { emoji: "😨", labelCs: "Strach", category: "feelings" },
  { emoji: "😖", labelCs: "Bolí", category: "feelings" },
  { emoji: "🥱", labelCs: "Unavený", category: "feelings" },
  { emoji: "😌", labelCs: "Klid", category: "feelings" },
  { emoji: "🥳", labelCs: "Nadšený", category: "feelings" },
  { emoji: "😕", labelCs: "Nevím", category: "feelings" },
  { emoji: "😍", labelCs: "Líbí", category: "feelings" },
  ...
  { emoji: "👧", labelCs: "Sestra", category: "social" },
  { emoji: "🧒", labelCs: "Brácha", category: "social" },
  { emoji: "👋", labelCs: "Ahoj", category: "social" },
  { emoji: "🙏", labelCs: "Děkuji", category: "social" },
  { emoji: "💋", labelCs: "Pusa", category: "social" },
  ...
  { emoji: "🍓", labelCs: "Jahoda", category: "food" },
  { emoji: "🍞", labelCs: "Pečivo", category: "food" },
  { emoji: "🥣", labelCs: "Kaše", category: "food" },
  { emoji: "🍲", labelCs: "Polévka", category: "food" },
